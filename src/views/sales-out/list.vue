<template>
  <div class="app-container">
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="220px" align="center" label="淘宝订单号">
        <template slot-scope="scope">
          <span>{{ scope.row.tb_billcode }}</span>
        </template>
      </el-table-column>
...
<script>
import { fetchList, deleteSalesOut } from '@/api/salesout'

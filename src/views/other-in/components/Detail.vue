...
import { fetchOtherIn, createOtherIn, updateOtherIn } from '@/api/otherin'
...
export default {
  ...
  methods: {
    ...
    fetchData(id) {
      fetchOtherIn(id).then(response => {
        console.log(response.data)
        this.postForm = response.data

        // just for test
        this.postForm.title += `生产入库单号:${this.postForm.billcode}`

...
import { fetchSalesOut, createSalesOut, updateSalesOut } from '@/api/salesout'
...
export default {
  ...
  methods: {
    ...
    fetchData(id) {
      fetchSalesOut(id).then(response => {
        console.log(response.data)
        this.postForm = response.data

        // just for test
        this.postForm.title += `   销售出库单号:${this.postForm.billcode}`
